...
description: "Interactive SQL editor for exploring Epic EHI data"
---
...
- **PATIENT_ID** - Additional patient identifiers
...
- **PROC_RES** - Procedure results
- **RESULT** - Lab results

### Administrative Data
- **CLARITY_DEP** - Departments
- **CLARITY_LOC** - Locations
- **CLARITY_EMP** - Providers/Employees
- **CLARITY_EPP** - Provider profiles

### Billing Data
- **ARPB_TX_VOID** - Professional billing transactions
- **HSB_TRANSACTIONS** - Hospital billing transactions
