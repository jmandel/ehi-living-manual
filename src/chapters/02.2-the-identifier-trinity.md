...
Nearly every clinical table contains PAT_ID as a foreign key. It's the universal patient linker.

<example-query description="Count tables using PAT_ID">
SELECT 
...
SELECT 
  ...
  ha.TOT_PMTS as payments,
  ha.TOT_CHGS - ha.TOT_PMTS as balance
FROM HSP_ACCOUNT ha
